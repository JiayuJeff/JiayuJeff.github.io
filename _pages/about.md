...
- Improving model truthworthiness: information fact-checking [work here](https://aclanthology.org/2024.fever-1.14.pdf) and verbal uncertainty elicitation and calibration [work here](https://arxiv.org/pdf/2505.24778).
- Enhancing model reasoning capabilities: How current SoTA Large reasoning models fail in reasoning process [work here](https://arxiv.org/abs/2506.17114) and how we could implement post-training algorithms to train the model beyond simple accuracy to enhance their performance [work here](https://openreview.net/pdf?id=T0TXd2DQxn).
